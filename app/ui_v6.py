...
from app.dev_ui import attach_dev_button
...
def hex_corners(center: QtCore.QPointF, size: float) -> List[QtCore.QPointF]:
    # pointy-top corners (30Р вЂ™Р’В°, 90Р вЂ™Р’В°, ...)
    pts = []
    for i in range(6):
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CATAN Р Р†Р вЂљРІР‚Сњ Desktop (UI v6: correct geometry & spots)")
        ...
        self.chat_in.setPlaceholderText("Say somethingР Р†Р вЂљР’В¦")
